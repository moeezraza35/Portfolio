  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4">
      ...
      <div className="relative z-10 max-w-xl text-center">
        ...
        <h1 className="mt-6 font-display text-8xl font-black tracking-tighter text-foreground sm:text-9xl">
          404
        </h1>
        ...
        <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-muted-foreground">
          The URL you entered doesn't match anything on this site. Double-check the
          address or head back home to explore my work.
        </p>
