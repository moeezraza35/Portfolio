      ...
      <div className="fixed inset-x-0 top-0 z-50 px-3 pt-3 sm:px-6 sm:pt-4">
        <div
          className={[
            ...
            scrolled
              ? "border-transparent bg-white/10 text-foreground shadow-[0_10px_40px_-12px_rgba(0,0,0,0.15)] backdrop-blur-lg"
          ...
          <a href="/" className="flex items-center gap-2 font-display font-bold">
            <img src={scrolled ? favicon.src : logowhite.src} alt="MR" className="h-7 w-7"/>
